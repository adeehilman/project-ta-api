...
class MmsController extends Controller
{
    ...
    public function pengajuan(Request $request)
    {
        ...
        $query = "SELECT imei1, imei2 FROM tbl_mms WHERE imei1 = '$request->imei1' OR imei2 ='$request->imei2'";
    ...
    public function getRiwayatMMS($id_mms, $id_status_terakhir)
    {
        ...
        foreach ($data_baru as $key => $item) {
            if(  
                $item->status_riwayat_id == 2 ||
                $item->status_riwayat_id == 4 ||
                $item->status_riwayat_id == 7 ||
                $item->status_riwayat_id == 9 
           ){
                $item->stat_desc = '';
           }
